...
\texttt{R_X86_64_16} or \texttt{R_X86_64_PC8}
...
resp. 8-bits.  The \texttt{R_X86_64_PC16} relocation truncates the computed
value to 16 bit, and the linker should verify that it sign-extends to the
original value.
\end{sloppypar}
